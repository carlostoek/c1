...
def validate_user_data(user_data: dict) -> Tuple[bool, str]:
    """Valida estructura de datos de usuario para misiones."""
    required = ['user_id', 'current_streak', 'total_reactions']
    types = {'user_id': int, 'current_streak': int, 'total_reactions': int}
