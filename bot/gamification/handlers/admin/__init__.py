...
from bot.gamification.handlers.admin.config import router as admin_config_router
...
admin_main_router.include_router(admin_config_router)

# Export main router as 'router' to match expected interface
router = admin_main_router

__all__ = ["router", "admin_main_router", "admin_mission_wizard_router", "admin_reward_wizard_router", "admin_templates_router", "admin_stats_router", "admin_reaction_config_router", "admin_level_config_router", "admin_mission_config_router", "admin_reward_config_router", "admin_transaction_history_router", "admin_config_router"]